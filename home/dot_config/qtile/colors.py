...
Dracula  = [
    ["#282a36", "#282a36"], # bg
    ["#f8f8f2", "#f8f8f2"], # fg
    ["#000000", "#000000"], # color02 black
    ["#ff5555", "#ff5555"], # color03 red
    ["#50fa7b", "#50fa7b"], # color04 green
    ["#f1fa8c", "#f1fa8c"], # color05 yellow
    ["#bd93f9", "#bd93f9"], # color06 purple
    ["#ff79c6", "#ff79c6"], # color07 pink
    ["#8be9fd", "#8be9fd"], # color08 cyan
    ["#ffb86c", "#ffb86c"], # color09 orange
    ["#6272a4", "#6272a4"]  # color10 comment 
    ]
